...
/**
 * AppUserDetailViewId generated by hbm2java
 */
@Embeddable
public class AppUserDetailViewId implements java.io.Serializable {
	...
	public AppUserDetailViewId() {
	}

	public AppUserDetailViewId(long userIdId, long createdBy, Date createdDate, long disableBy) {
	...
	public AppUserDetailViewId(long userIdId, String userFirstName, String userLastName, String mailIdOfc,
			...
			Date disableDate, long disableBy, Long userId, String userName, String encrytedPassword, Boolean enabled) {
		this.userIdId = userIdId;
	...
	@Column(name = "mail_id_ofc", length = 50)
	...
	@Column(name = "mail_id_personal", length = 50)
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof AppUserDetailViewId))
			return false;
		AppUserDetailViewId castOther = (AppUserDetailViewId) other;
		...
		return (this.getUserIdId() == castOther.getUserIdId())
				...
				&& ((this.getEncrytedPassword() == castOther.getEncrytedPassword())
						|| (this.getEncrytedPassword() != null && castOther.getEncrytedPassword() != null
								&& this.getEncrytedPassword().equals(castOther.getEncrytedPassword())))
	...
	public int hashCode() {
		...
		result = 37 * result + (getEncrytedPassword() == null ? 0 : this.getEncrytedPassword().hashCode());
