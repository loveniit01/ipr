...
/**
 * UploadDataViewPmqcId generated by hbm2java
 */
@Embeddable
public class UploadDataViewPmqcId implements java.io.Serializable {
	...
	public UploadDataViewPmqcId() {
	}

	public UploadDataViewPmqcId(long id, String link, String domainName, String sourceLink, long projectId,
			String projectType) {
		this.id = id;
		this.link = link;
	...
	public boolean equals(Object other) {
		...
		if ((other == null))
			return false;
		if (!(other instanceof UploadDataViewPmqcId))
			return false;
		UploadDataViewPmqcId castOther = (UploadDataViewPmqcId) other;
